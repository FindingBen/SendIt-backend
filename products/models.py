...
class RulesPattern(models.Model):
    ...
    product_name_rule = models.CharField(max_length=150, blank=True, null=True)
    product_description_rule = models.CharField(max_length=150, blank=True, null=True)
    product_image_rule = models.CharField(max_length=150, blank=True, null=True)
    product_variant_rule = models.CharField(max_length=150, blank=True, null=True)
    product_tag_rule = models.CharField(max_length=150, null=True, blank=True)
    product_alt_image_rule = models.CharField(max_length=150, null=True, blank=True)
