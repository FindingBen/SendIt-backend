...
STRIPE_PURCHASE_WEBHOOK_SECRET = os.environ['STRIPE_PURCHASE_WEBHOOK_SECRET']
...
SHOPIFY_SCOPES = "read_products,write_products,write_orders,read_customers,write_customers,write_files"
