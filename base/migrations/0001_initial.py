# Generated by Django 4.2.16 on 2025-08-10 13:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scheduled_subscription', models.DateField(blank=True, null=True)),
                ('scheduled_package', models.CharField(default=None, null=True)),
                ('scheduled_cancel', models.CharField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campaign_type', models.CharField(choices=[('Promotional', 'Promotional'), ('Notification', 'Notification')], max_length=25, null=True)),
                ('sms_text', models.TextField(max_length=150, null=True)),
                ('sms_send', models.CharField(choices=[('Send', 'Send'), ('Schedule', 'Schedule')], max_length=20, null=True)),
                ('users', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank=True, null=True, upload_to='')),
                ('image_src', models.URLField(blank=True, max_length=300, null=True)),
